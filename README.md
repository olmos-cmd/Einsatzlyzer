...
<p align="center">
  ...
  <a href="CHANGELOG.md">Changelog</a> · <a href="RELEASE_NOTES_10.6.11.md">Release notes</a> ·
  <a href="LICENSE">License</a>
</p>

> **Version 10.6.11 · WordPress Plugin · PHP 8.x · GPL-2.0-or-later**  
...
**Einsatzlyzer 10.6.11** is an independent WordPress plugin for recording, managing and publishing emergency incident reports. It combines a structured administration workflow with a responsive public incident archive and keeps all data under the control of the WordPress site owner.
...
2. Select `Einsatzlyzer-10.6.11.zip`.
...
2. `Einsatzlyzer-10.6.11.zip` auswählen.
