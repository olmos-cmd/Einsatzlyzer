...
define( 'FFL_EINSATZLYZER_VERSION', '10.0.0' );
...
function ffl_render_einstellungen_page() {
    ...
    <div class="wrap ffl-settings-wrap">
        <div class="ffl-admin-page-brand ffl-admin-page-brand--compact"><img src="<?php echo esc_url( FFL_EINSATZLYZER_URL . 'images/branding/einsatzlyzer-logo.png' ); ?>" alt="Einsatzlyzer"><div><h1>Einsatzlyzer Einstellungen</h1><p>Darstellung, Navigation und Karten zentral verwalten.</p></div></div>
