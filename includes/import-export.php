...
const FFL_IMPEX_SCHEMA_VERSION = 7;
...
/**
 * Dokumentiert die seit Schema-Version 7 ausdrücklich abgesicherten
 * weiterführenden Links einschließlich ihrer Quellangaben. Obwohl die
 * vollständige Sicherung grundsätzlich alle _ffl_-Metafelder exportiert,
 * werden diese Felder hier zusätzlich als fester Sicherungsvertrag geführt.
 */
function ffl_impex_external_links_backup_contract() {
    $fields = array();
    for ( $i = 1; $i <= 5; $i++ ) {
        $fields[] = '_ffl_link_' . $i;
        $fields[] = '_ffl_link_source_' . $i;
    }
    return array(
        'incident_meta' => $fields,
        'pairs' => 5,
    );
}
...
function ffl_impex_build_backup( $post_ids, $options, $target_file = '' ) {
    ...
    $manifest = array(
        ...
        'data_contract'   => array(
            ...
            'external_links' => ffl_impex_external_links_backup_contract(),
