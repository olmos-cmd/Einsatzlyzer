            ...
            <div class="ffl-single-main">
                ...
                <?php if ( $gallery_ids ) : ?>
                    <section id="einsatzbilder" class="ffl-gallery-section">
                        <header class="ffl-section-heading ffl-section-heading--split"><div><span class="ffl-section-kicker"><?php echo esc_html( ffl_lang( 'Einsatzbilder', 'Incident Images' ) ); ?></span><h2><?php echo esc_html( ffl_lang( 'Impressionen vom Einsatz', 'Incident Gallery' ) ); ?></h2></div><span class="ffl-photo-count"><?php echo esc_html( count( $gallery_ids ) ); ?> <?php echo esc_html( count( $gallery_ids ) === 1 ? ffl_lang( 'Bild', 'Image' ) : ffl_lang( 'Bilder', 'Images' ) ); ?></span></header>
                ...
                <?php if ( $links ) : ?>
                    <section class="ffl-links-section">
                        ...
                        <div class="ffl-external-links">
                            <?php foreach ( $links as $index => $url ) : ?><a href="<?php echo esc_url( $url ); ?>" target="_blank" rel="noopener noreferrer"><span><?php echo esc_html( ffl_lang( 'Externer Bericht', 'External Report' ) ); ?> <?php echo esc_html( $index + 1 ); ?></span><?php echo ffl_icon( 'arrow' ); ?></a><?php endforeach; ?>
                        </div>
                    </section>
                <?php endif; ?>
            </div>
            ...
            <aside class="ffl-single-sidebar">
                <div class="ffl-sidebar-card">
                    ...
                    <dl>
                        ...
                        <?php if ( $leader ) : ?><div><dt><?php echo esc_html( ffl_lang( 'Einsatzleiter', 'Incident Commander' ) ); ?></dt><dd><?php echo esc_html( $leader ); ?></dd></div><?php endif; ?>
                        <?php if ( $personnel ) : ?><div><dt><?php echo esc_html( ffl_lang( 'Einsatzkräfte', 'Personnel' ) ); ?></dt><dd><?php echo esc_html( $personnel ); ?></dd></div><?php endif; ?>
